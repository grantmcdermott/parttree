...
easily understood by **ggplot2**. For example, consider again the "iris_tree" 
...
see what I mean, let's redo our iris plot from earlier, but this time switch 
...
(as is the case here). But it's admittedly annoying. I'll try to add better 
